...
import { fetchTodosAsync, addTodoAsync, toggleTodo, deleteTodo, editTodo } from '../redux/slice/TodoSlice';
...
const TodoList = () => {
  ...
  const handleAddTodo = async () => {
    if (inputTodo.trim() !== '') {
      // Dispatch addTodoAsync instead of addTodo
      await dispatch(addTodoAsync(inputTodo)); // Use addTodoAsync
      setInputTodo('');
    }
  };
