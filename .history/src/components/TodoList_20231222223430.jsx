    ...
    <div className="min-h-screen overflow-x-hidden overflow-y-hidden">
      ...
      <div className="rounded-xl shadow-md overflow-hidden mx-auto my-4 md:my-8 lg:my-12">
        <div className=" overflow-hidden rounded-xl shadow-md">
          ...
          />
          <button
            className="bg-white text-black border-2 border-black px-2 py-2 rounded"
          ...
          <div className="mt-4 mx-4 flex space-x-2 ">
            ...
            <button className="mr-2 hover:bg-violet-600" onClick={handleShowActive}>
              Active
            </button>
            <button className='hover:bg-violet-600' onClick={handleShowCompleted}>Completed</button>
          </div>
