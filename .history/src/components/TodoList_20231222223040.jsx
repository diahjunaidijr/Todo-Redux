...
const TodoList = () => {
  ...
  return (
    ...
    <div className="min-h-screen overflow-x-hidden overflow-y-hidden">
      <p className='underline hover:decoration-dashed'>Todo List</p>
        ...
        <div className=" overflow-hidden rounded-xl shadow-md">
          ...
          <ul className="mt-4">
                  {filteredTodos.map((todo) => (
                    <li
                      key={todo.id}
                      className="flex items-left justify-items-stretch bg-white text-black mx-4 my-4 px-4 py-4 border-double border-4 border-black-500 flex-col"
                    >
