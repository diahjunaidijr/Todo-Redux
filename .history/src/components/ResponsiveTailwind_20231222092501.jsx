function ResponsiveTailwind() {
  return (
    ...
    <span className="inline-flex items-baseline">
        <img className="self-center w-5 h-5 rounded-full mx-1" src="https://cdn2.vectorstock.com/i/1000x1000/54/81/cute-animal-friends-cartoon-vector-21595481.jpg" alt="halo" />
        <span>Kramer</span>
    </span>
