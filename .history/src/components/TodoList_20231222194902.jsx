...
<div className="min-h-screen overflow-x-hidden">
  <div className="rounded-xl shadow-md overflow-hidden mx-auto my-4 md:my-8 lg:my-12">
    <div className=" overflow-hidden rounded-xl bg-indigo-500 shadow-md">
      <div className="flex items-center mt-4 mx-4">
      <input
        className="text-white mr-4 min-h-10 min-w-10 px-2 border rounded"
        type="text"
        value={inputValue}
      ...
      <ul className="mt-4">
        {filteredTodos.map((todo) => (
          <li
            key={todo.id}
            className="flex items-left justify-items-stretch text-black mx-4 my-4 px-4 py-4 border-double border-4 border-white-500 flex-col"
          >
