function ResponsiveTailwind() {
  return (
    ...
    <div className="flex ...">
    <div className="flex-1 bg-purple-500">01</div>
    <div className="contents">
        <div className="flex-1 bg-yellow-500">02</div>
        <div className="flex-1 bg-green-500">03</div>
    </div>
    <div className="flex-1 bg-red-500">04</div>
    </div>
