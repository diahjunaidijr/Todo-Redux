    ...
    <div className=" overflow-hidden rounded-xl shadow-md">
      ...
      <ul className="mt-4">
        {filteredTodos.map((todo) => (
          <li
            key={todo.id}
            className="flex items-left justify-items-stretch text-black mx-4 my-4 border-double border-4 border-white-500 flex-col"
          >
            ...
            <div className="flex">
              {editTodoId === todo.id ? (
                ...
                <>
                  ...
                  <div className="flex">
                    <button
                      className="bg-white text-black px-2 py-1 mx-2 my-1 rounded"
