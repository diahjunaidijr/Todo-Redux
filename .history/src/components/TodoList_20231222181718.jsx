    ...
    <div className="overflow-hidden rounded-xl bg-white shadow-md">
      ...
      <ul className="mt-4">
        {filteredTodos.map((todo) => (
          <li
            key={todo.id}
            className="flex items-left space-x-2 justify-items-stretch text-black mx-4 my-4 px-4 py-4 border-double border-4 border-white-500 lg:flex-row md:flex-col"
          >
            {editTodoId === todo.id ? (
              <>
                <input
