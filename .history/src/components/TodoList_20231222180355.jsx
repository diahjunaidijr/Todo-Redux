...
<div className="flex justify-center items-center min-h-screen overflow-x-hidden">
  <div className="max-w-screen-lg w-full bg-white rounded-xl shadow-md overflow-hidden mx-auto my-4 md:my-8 lg:my-12">
    <div className="overflow-hidden rounded-xl bg-white shadow-md duration-200 hover:scale-105 hover:shadow-xl">
      ...
      <ul className="mt-4">
        {filteredTodos.map((todo) => (
          <li
            key={todo.id}
            className="flex items-left justify-items-stretch mx-4 my-4 px-4 py-4 border-double border-4 border-white-500 lg:flex-row md:flex-col"
          >
            {editTodoId === todo.id ? (
              <>
                <input
