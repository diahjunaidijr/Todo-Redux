...
const TodoList = () => {
  ...
  return (
    <div className="max-w-md h-screen justify-center items-center md:max-w-2xl bg-white px-4 py-4 mx-4 my-4">
      <div className="md:flex overflow-hidden rounded-xl bg-teal-900 shadow-md duration-200 hover:scale-105 hover:shadow-xl w-full transition px-4 py-4">
        <input
