...
const TodoList = () => {
  ...
  return (
    <div className="flex w-screen h-screen justify-center align-item-center bg-white px-4">
      <div className="overflow-hidden rounded-xl bg-teal-900 shadow-md duration-200 hover:scale-105 hover:shadow-xl px-4 py-4">
        <input
