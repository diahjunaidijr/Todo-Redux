    ...
    <div className="max-w-lg mx-auto bg-white rounded-xl shadow-md overflow-hidden lg:max-w-2xl">
        ...
        <div className="flex space-x-4">
            ...
            <div className="flex flex-col space-y-4">
                <p>Contoh vertical space between children</p>
                <div className="bg-black text-white">01</div>
                <div className="bg-slate-500 text-white">02</div>
                <div className="bg-indigo-500 text-white">03</div>
            </div>
            <div className="flex flex-row-reverse space-x-4 space-x-reverse">
                <p>Reversing children order</p>
                <div className="bg-black text-white">01</div>
                <div className="bg-slate-500 text-white">02</div>
                <div className="bg-indigo-500 text-white">03</div>
            </div>
            <div className="flex -space-x-4">
                <p>Using negative values</p>
                <div className="bg-black text-white">01</div>
                <div className="bg-slate-500 text-white">02</div>
                <div className="bg-indigo-500 text-white">03</div>
            </div>
            <div className="flow-root">
                <p>gap utilities for handle complex cases like grids, layouts that wrap, or situations where the children are rendered in a complex custom order rather than their natural DOM order</p>
