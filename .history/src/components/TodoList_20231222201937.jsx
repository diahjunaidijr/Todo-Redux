...
<div className="min-h-screen overflow-x-hidden">
  <div className="rounded-xl shadow-md overflow-hidden mx-auto my-4 md:my-8 lg:my-12">
    <div className=" overflow-hidden rounded-xl shadow-md">
      <div className="flex items-center mt-4 mx-4 fixed">
      <input
        className="text-white mr-4 min-h-10 lg:w-96 md:w-96 sm:w-2 border rounded"
        type="text"
        value={inputValue}
      ...
      <div className="mt-4 mx-4 flex space-x-2 fixed top-40">
