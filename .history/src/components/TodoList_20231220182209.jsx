...
const TodoList = () => {
  ...
  return (
    <div className="flex max-w-screen-lg items-center justify-center bg-white px-4">
      <div className="max-w-screen-md overflow-hidden rounded-xl bg-teal-900 transition-transform duration-200 hover:scale-105 hover:shadow-xl px-4 py-4">
        <input
