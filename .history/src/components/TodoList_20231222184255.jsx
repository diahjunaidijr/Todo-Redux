...
const TodoList = () => {
  ...
  return (
<div className="justify-center min-h-screen overflow-x-hidden">
  <div className="bg-white rounded-xl shadow-md overflow-hidden mx-auto my-4 md:my-8 lg:my-12">
    <div className="inline-flex flex-col overflow-hidden rounded-xl bg-white shadow-md">
      <input
